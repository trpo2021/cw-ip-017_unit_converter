...
void weight_calc(vector<double> &elements, double input_element,
...
void from_double_to_char(vector<double> elements, int i,
                         const gchar *input_char, GtkEntry *output) {
  string temprory;
  stringstream ss;
  ss << elements[i];
  ss >> temprory;
...
void time(vector<double> &elements, double input_element,
          int position_of_element) {
  int i;
