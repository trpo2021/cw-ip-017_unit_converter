...
void calc_button_clicked(GtkWidget *widget, gpointer data) {
  ...
  if (gtk_combo_box_get_active(types) == 3) {
    ...
    if (strcmp(gtk_combo_box_text_get_active_text(object_of_types1), USQuart) ==
        0) {
      ;
    ...
    if (strcmp(gtk_combo_box_text_get_active_text(object_of_types1), ImpPint) ==
        0) {
      ;
    ...
    if (strcmp(gtk_combo_box_text_get_active_text(object_of_types2), USQuart) ==
        0) {
      ;
    } // from_double_to_char(elements, 7, input_char, output);
    ...
    if (strcmp(gtk_combo_box_text_get_active_text(object_of_types2), ImpPint) ==
        0) {
      ;
...
int main(int argc, char *argv[]) {
  ...
  g_signal_connect(G_OBJECT(mainflow), "delete-event", G_CALLBACK(cb_delete),
                   NULL);
