...
void calc_button_clicked (GtkWidget* widget, gpointer data) {
    ...
    if (gtk_combo_box_get_active (types) == 0) {
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), M) == 0) {
            ;
        } // lenght(elements,input_element,0);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), Km) == 0) {
            ;
        } // lenght(elements,input_element,1);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), Cm) == 0) {
            ;
        } // lenght(elements,input_element,2);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), Mm) == 0) {
            ;
        } // lenght(elements,input_element,3);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), Mcm) == 0) {
            ;
        } // lenght(elements,input_element,4);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), Nm) == 0) {
            ;
        } // lenght(elements,input_element,5);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), Mile) == 0) {
            ;
        } // lenght(elements,input_element,6);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), Yard) == 0) {
            ;
        } // lenght(elements,input_element,7);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), Foot) == 0) {
            ;
        } // lenght(elements,input_element,8);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), Inch) == 0) {
            ;
        } // lenght(elements,input_element,9);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), LY) == 0) {
            ;
    ...
    if (gtk_combo_box_get_active (types) == 1) {
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), C) == 0) {
            ;
        } // temp(elements,input_element,0);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), K) == 0) {
            ;
        } // temp(elements,input_element,1);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), F) == 0) {
            ;
    ...
    if (gtk_combo_box_get_active (types) == 2) {
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), SM) == 0) {
            ;
        } // area(elements,input_element,0);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), SKm) == 0) {
            ;
        } // area(elements,input_element,1);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), SCm) == 0) {
            ;
        } // area(elements,input_element,2);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), SMm) == 0) {
            ;
        } // area(elements,input_element,3);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), SMm) == 0) {
            ;
        } // area(elements,input_element,4);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), Hec) == 0) {
            ;
        } // area(elements,input_element,5);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), SMile) == 0) {
            ;
        } // area(elements,input_element,6);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), SYard) == 0) {
            ;
        } // area(elements,input_element,7);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), SFoot) == 0) {
            ;
        } // area(elements,input_element,8);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), SInch) == 0) {
            ;
        } // area(elements,input_element,9);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), Ac) == 0) {
            ;
    ...
    if (gtk_combo_box_get_active (types) == 3) {
        ...
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), CKm) == 0) {
            ;
        } // volume(elements,input_element,1);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), CCm) == 0) {
            ;
        } // volume(elements,input_element,2);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), CMm) == 0) {
            ;
        } // volume(elements,input_element,3);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), Lit) == 0) {
            ;
        } // volume(elements,input_element,4);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), Mlit) == 0) {
            ;
        } // volume(elements,input_element,5);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), USGallon) == 0) {
            ;
        } // volume(elements,input_element,6);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), USQuart) == 0) {
            ;
        } // volume(elements,input_element,7);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), USPint) == 0) {
            ;
        } // volume(elements,input_element,8);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), USCup) == 0) {
            ;
        } // volume(elements,input_element,9);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), USFOunce) == 0) {
            ;
        } // volume(elements,input_element,10);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), USTableSpoon) == 0) {
            ;
        } // volume(elements,input_element,11);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), ImpGallon) == 0) {
            ;
        } // volume(elements,input_element,12);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), ImpQuart) == 0) {
            ;
        } // volume(elements,input_element,13);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), ImpPint) == 0) {
            ;
        } // volume(elements,input_element,14);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), ImpFOunce) == 0) {
            ;
        } // volume(elements,input_element,15);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), ImpTableSpoon) == 0) {
            ;
        } // volume(elements,input_element,16);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), ImpTeaSpoon) == 0) {
            ;
        } // volume(elements,input_element,17);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), CMile) == 0) {
            ;
        } // area(elements,input_element,18);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), CYard) == 0) {
            ;
        } // area(elements,input_element,19);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), CFoot) == 0) {
            ;
        } // area(elements,input_element,20);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), CInch) == 0) {
            ;
    ...
    if (gtk_combo_box_get_active (types) == 5) {
        ...
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), Msec) == 0) {
            ;
        } // time(elements,input_element,1);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), Mcsec) == 0) {
            ;
        } // time(elements,input_element,2);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), Nsec) == 0) {
            ;
        } // time(elements,input_element,3);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), Psec) == 0) {
            ;
        } // time(elements,input_element,4);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), Min) == 0) {
            ;
        } // time(elements,input_element,5);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), Hour) == 0) {
            ;
        } // time(elements,input_element,6);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), Day) == 0) {
            ;
        } // time(elements,input_element,7);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), Week) == 0) {
            ;
        } // time(elements,input_element,8);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), Month) == 0) {
            ;
        } // time(elements,input_element,9);
        if (strcmp (gtk_combo_box_text_get_active_text (object_of_types1), Year) == 0) {
            ;
...
int main (int argc, char* argv[]) {
    ...
    object_of_types1 =
    GTK_COMBO_BOX_TEXT (gtk_builder_get_object (builder, "object_of_types1"));
    object_of_types2 =
    GTK_COMBO_BOX_TEXT (gtk_builder_get_object (builder, "object_of_types2"));
    liststore1 =
    GTK_LIST_STORE (gtk_builder_get_object (builder, "liststore1"));
    thing = GTK_IMAGE (gtk_builder_get_object (builder, "thing"));
    lenght =
    GTK_CELL_RENDERER_TEXT (gtk_builder_get_object (builder, "lenght"));
    ...
    volume =
    GTK_CELL_RENDERER_TEXT (gtk_builder_get_object (builder, "volume"));
    weight =
    GTK_CELL_RENDERER_TEXT (gtk_builder_get_object (builder, "weight"));
    time_not_timeh =
    GTK_CELL_RENDERER_TEXT (gtk_builder_get_object (builder, "time_not_timeh"));

    gtk_builder_connect_signals (builder, NULL);

    g_signal_connect (G_OBJECT (calc_button), "clicked",
                      G_CALLBACK (calc_button_clicked), NULL);
    g_signal_connect (G_OBJECT (change_button), "clicked",
                      G_CALLBACK (change_button_clicked), NULL);
    g_signal_connect (G_OBJECT (mainflow), "delete-event", G_CALLBACK (cb_delete), NULL);
