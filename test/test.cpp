...
CTEST(Conversion, length_conversion) {
  ...
  vector<double> elements = {
      1, 0.001, 1.e+2, 1.e+3, 1.e+6, 1.e+9, 1.e+9 / 1609350000000e+0,
...
CTEST(Conversion, weight_conversion) {
  ...
  vector<double> elements = {
      1, 1.e+3, 1.e+6, 1.e-3, 1.e-3 / 1.01604608e+0,
      ...
      (1.e-3 * 1.12e+0 * 2000e+0 * 16e+0 * 141.7475e+0 * 1.20442733033504e+23) /
          1.01604608e+0};
